...
const tplAddress1 = 'vADDR1v'
const tplAddress1Url = 'vADDR1URLv'
const tplAddress2 = 'vADDR2v'
...
function replaceSvgFile(keys) {
    ...
    var addr1 = address1.substr(0,17)
    var addr12 = address1.substr(17,17)
    var addr2 = address2.substr(0,17)
    var addr22 = address2.substr(17,17)

    cp(tplSvg, svgFile)
    sed('-i', tplAddress1, address1, svgFile)
    sed('-i', tplAddress2, address2, svgFile)
    ...
    var options = {
        ...
        // size 740x740
    qr_cairo.save(addr1url, 'qraddr1.png', options)
    qr_cairo.save(addr2url, 'qraddr2.png', options)
}
